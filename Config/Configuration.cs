...
sealed class Configuration {
    ...
    public Configuration(ConfigFile c) {
        const string enabledDescription = "Turn this mod's growth model on or off. Off = colonies grow exactly like vanilla.";
        Enabled = c.Bind("PopulationScaling", "Enabled", true, enabledDescription);

        const string maxRateDescription = "The fastest a colony can grow in a year (as a fraction of its current population) when it "
        ...
        const string minRateDescription = "The slowest a colony can grow once housing is nearly full or stored supply is nearly out. "
        ...
        const string plateauAvailableFractionDescription = "How much of a colony's housing needs to be empty (as a fraction of total capacity) before "
        ...
        PlateauAvailableFraction = c.Bind("PopulationScaling", "PlateauAvailableFraction", 0.50, plateauAvailableFractionDescription);

        const string supplyBufferDaysDescription = "How many days' worth of stored supply (food/consumables) a colony needs banked to grow at "
        ...
        const string minPopulationDescription = "The smallest a colony can be and still grow at all. 0 (the default) lets even a brand-new "
        ...
        const string debugLoggingDescription = "Writes one log line per colony every time this mod's growth calculation runs, showing the "
